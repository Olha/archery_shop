				...
				<div className='container'>
					<div className='header-inner'>
						<div className='branding'>
							<h1 className='logo'>
								<a href='/'><img src='images/logo@2x.png' alt='' width='25' height='26'/>Archery</a>
							</h1>
						</div>
						<nav id='nav'>
							<ul className='header-top-nav'>
								...
								<li className='visible-mobile'>
									<a href='#mobile-nav-wrapper' data-toggle='collapse'><i className='fa fa-bars has-circle'></i></a>
								</li>
							</ul>
