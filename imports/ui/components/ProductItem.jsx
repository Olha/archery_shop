		...
		return (
			<div className='iso-item-product'>
				<div className='product'>
					<a href={FlowHelpers.pathFor(`/lists/${ product.listId }/products/${ product._id }`)} title={product.name} className='product-image'>
					...
					<div className='product-content'>
						...
						<span className='product-price'>
							<span className='currency-symbol'>{product.price.currency}</span>{product.price.value}</span>
