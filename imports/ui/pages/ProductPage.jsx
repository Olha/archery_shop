              ...
              <div className="product type-product">
                ...
                <div className="woocommerce-tabs tab-container vertical-tab clearfix box">
                  ...
                  <div id="tab3-2" className="tab-content panel entry-content">
                    <div className="tab-pane">
                      <dl className="shop_attributes">
                        ...
                        <dd>Because the GFT is a feminine cut,
                          we recommend sticking to your usual size :)</dd>
                      </dl>
                    </div>
                  </div>
                  <div id="tab3-3" className="tab-content panel entry-content in active">
                    <div className="tab-pane">
                      <div id="comments">
                        <a href="#" className="btn btn-sm style1 btn-write-review">
                          <i className="fa fa-pencil"></i>Write Review</a>
                          ...
                          <li className="comment">
                            ...
                            <div className="comment-content">
                              ...
                              <div className="description">
                                <p>Nulla mattis rsitmet dolor sollicitudi aliquamquae ab illo
                                  inventore veritatis et quasi architecto beatae vitae dicta sunt
                                  explicabo Lorem ipsum dolor sit amet gravida sagittis lacus.
                                  Morbi sit amet mauris mi.</p>
                              </div>
                            </div>
                          </li>
                          <li className="comment">
                            ...
                            <div className="comment-content">
                              ...
                              <div className="description">
                                <p>Nulla mattis rsitmet dolor sollicitudi aliquamquae ab illo
                                  ...
                                  sunt explicabo Lorem ipsum dolor sit amet gravida sagittis
                                  lacus. Morbi sit amet mauris mi.</p>
                              </div>
                            </div>
                          </li>
                        </ol>
                      ...
                      <div id="review_form">
                        <form>
                          <a href="#" className="btn btn-sm style4 btn-back-reviews">
                      ...
                      <form className="add-product-tags">
                        <div className="row">
                          <div className="col-md-9 col-lg-7">
                            ...
                            <div className="form-group">
                              <button type="submit" className="btn btn-medium style1">
                                Add Tags
                              </button>
                            </div>
                          </div>
                ...
                <ul className="related products row add-clearfix">
                  <li className="product col-sms-6 col-sm-4 col-lg-3 box">
                    ...
                    <div className="product-content">
                      ...
                      >
                        <span data-stars="4"></span></span>
                    </div>
                    <div className="product-action">
                      <a className="btn btn-add-to-cart" href="#">
                        <i className="fa fa-shopping-cart"></i>Add To Cart</a>
                      <a className="btn btn-add-to-wishlist" href="#">
                        <i className="fa fa-heart"></i></a>
                      <a
                        href="ajax/woocommerce-product-quickview.html"
                        className="btn btn-quick-view"
                      >
                        <i className="fa fa-search"></i></a>
                      <a className="btn btn-compare" href="#">
                        <i className="fa fa-star-half-o"></i></a>
                    </div>
                  </li>
                  <li className="product col-sms-6 col-sm-4 col-lg-3 box">
                    <a className="product-image" href="#">
                    ...
                    <div className="product-content">
                      ...
                      <span className="product-price"><span className="currency-symbol">$
                      </span>135.00</span>
                      <span
                        className="star-rating"
                        title=""
                  ...
                  <li className="product col-sms-6 col-sm-4 col-lg-3 box">
                    ...
                    <div className="product-content">
                      ...
                      <span className="product-price">
                        <span className="currency-symbol">$</span>34.80</span>
                      <span
                        className="star-rating"
                    ...
                    <div className="product-action">
                      ...
                      <a className="btn btn-add-to-wishlist" href="#">
                        <i className="fa fa-heart"></i></a>
                      <a href="ajax/woocommerce-product-quickview.html"
                        className="btn btn-quick-view"
                      >
                        <i className="fa fa-search"></i></a>
                      <a className="btn btn-compare" href="#">
                  ...
                  <li className="product col-sms-6 col-sm-4 col-lg-3 box">
                    ...
                    <div className="product-content">
                      <h5 className="product-title"><a href="#">Geo Dream Dress</a></h5>
                      <span className="product-price">
                        <span className="currency-symbol">$</span>112.00</span>
                      <span className="star-rating" title=""
                        data-toggle="tooltip" data-original-title="4"
                      >
                        <span data-stars="4"></span>
                      </span>
                    </div>
...
ProductPage.propTypes = {
  ...
  productExists: React.PropTypes.bool,
